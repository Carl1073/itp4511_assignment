...
@WebServlet(name = "handleNotification", urlPatterns = {"/handleNotification"})
public class handleNotification extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("read".equalsIgnoreCase(action)) {
            ...
            boolean success = ndb.markAsRead(notifId);
