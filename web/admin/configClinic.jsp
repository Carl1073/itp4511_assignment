                ...
                <div class="button-group">
                    <% if (selectedClinic != null) { %>
                        ...
                        <button type="submit" name="action" value="deleteClinic" class="btn-secondary" 
                                onclick="return confirm('⚠️ Are you sure you want to delete this clinic? This action cannot be undone.');">
                            🗑️ Delete Clinic
                        </button>
                    <% } else { %>
                        <!-- Add Mode: Show Create Clinic button only -->
                        <button type="submit" class="btn-primary">
                            ➕ Create Clinic
                        </button>
                    <% } %>
                    <a href="handleAdmin?action=configClinic" class="btn-back" style="text-decoration: none; display: inline-flex; align-items: center;">
                        ← Back to Clinic List
                    </a>
                </div>
            </form>
